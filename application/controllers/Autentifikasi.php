...
class Autentifikasi extends CI_Controller
{
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('page/template/auth_header', $data);
            $this->load->view('page/auth/login');
            $this->load->view('page/template/auth_footer');
        } else {
            $this->_login();
        }
    }
...
terdaftar!!</div>');
    ...
    {
        $this->load->view('page/auth/blok');
    }
    public function gagal()
    {
        $this->load->view('page/auth/gagal');
    }
...
Password', 'required|trim|matches[password1]');
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('page/template/auth_header', $data);
            $this->load->view('page/auth/registrasi');
            $this->load->view('page/template/auth_footer');
        } else {
